...
## Journey
- Initial idea was just to apply tranform property ( `rotate()` ) to a wheel using transitions and never to build a moving vehicle .
- Body of the car was  generated from nano banana and the wheel image and the city background were sourced from the internet.
